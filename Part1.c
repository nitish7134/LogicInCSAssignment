...
int main()
{
    ...
    scanf("%d", &n);
    scanf("\n%[^\n]%c", formula);   //Takes in input till new line including space.
    scanf("%s", operand_stack_val); //Takes in string of values of the atoms
    printf("%c", eval_formula(n, formula, operand_stack_val));
